...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('dar_entry', 'speaker', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Entry.party'
        db.alter_column('dar_entry', 'party', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Entry.speaker'
        db.alter_column('dar_entry', 'speaker', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Entry.party'
        db.alter_column('dar_entry', 'party', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

    models = {
        'dar.day': {
            'Meta': {'ordering': "['date']", 'object_name': 'Day'},
            'date': ('django.db.models.fields.DateField', [], {}),
            'diary_number': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'diary_series': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'legislative_session': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'legislature': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['deputados.Legislature']", 'null': 'True'}),
        ...
        'dar.entry': {
            ...
            'party': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'position': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'prev_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'raw_text': ('django.db.models.fields.TextField', [], {'max_length': '100000', 'blank': 'True'}),
            'speaker': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        'deputados.mp': {
            ...
            'photo': ('deputados.thumbs.ImageWithThumbsField', [], {'max_length': '100', 'null': 'True', 'sizes': '((18, 25), (60, 79))'}),
