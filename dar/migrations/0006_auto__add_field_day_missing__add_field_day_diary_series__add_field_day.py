...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Day.missing'
        db.add_column('dar_day', 'missing', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        ...
        # Adding field 'Day.diary_number'
        db.add_column('dar_day', 'diary_number', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Day.missing'
        db.delete_column('dar_day', 'missing')

        # Deleting field 'Day.diary_series'
        db.delete_column('dar_day', 'diary_series')

        # Deleting field 'Day.diary_number'
        db.delete_column('dar_day', 'diary_number')
