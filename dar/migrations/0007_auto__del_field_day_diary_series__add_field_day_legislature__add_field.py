...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Day.diary_series'
        db.delete_column('dar_day', 'diary_series')

        # Adding field 'Day.legislature'
        db.add_column('dar_day', 'legislature', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['deputados.Legislature'], null=True), keep_default=False)

        # Adding field 'Day.legislative_session'
        db.add_column('dar_day', 'legislative_session', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Day.diary_series'
        db.add_column('dar_day', 'diary_series', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Deleting field 'Day.legislature'
        db.delete_column('dar_day', 'legislature_id')

        # Deleting field 'Day.legislative_session'
        db.delete_column('dar_day', 'legislative_session')
