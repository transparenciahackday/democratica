...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MP.current_jobs'
        db.add_column('deputados_mp', 'current_jobs', self.gf('django.db.models.fields.TextField')(default='', max_length=5000, blank=True), keep_default=False)

        # Adding field 'MP.awards'
        db.add_column('deputados_mp', 'awards', self.gf('django.db.models.fields.TextField')(default='', max_length=5000, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MP.current_jobs'
        db.delete_column('deputados_mp', 'current_jobs')

        # Deleting field 'MP.awards'
        db.delete_column('deputados_mp', 'awards')
