...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MP.education'
        db.add_column('deputados_mp', 'education', self.gf('django.db.models.fields.TextField')(default='', max_length=5000, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MP.education'
        db.delete_column('deputados_mp', 'education')
