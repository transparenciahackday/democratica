...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MP.tweets'
        db.alter_column('deputados_mp', 'tweets', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'MP.photo'
        db.alter_column('deputados_mp', 'photo', self.gf('democratica.deputados.thumbs.ImageWithThumbsField')(max_length=100, null=True, name='photo', sizes=((18, 25), (60, 79))))

        # Changing field 'MP.news'
        db.alter_column('deputados_mp', 'news', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'MP.tweets'
        db.alter_column('deputados_mp', 'tweets', self.gf('django_extensions.db.fields.json.JSONField')(null=True))

        # Changing field 'MP.photo'
        db.alter_column('deputados_mp', 'photo', self.gf('deputados.thumbs.ImageWithThumbsField')(max_length=100, null=True, name='photo', sizes=((18, 25),)))

        # Changing field 'MP.news'
        db.alter_column('deputados_mp', 'news', self.gf('django_extensions.db.fields.json.JSONField')(null=True))
