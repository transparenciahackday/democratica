...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MP.current_party'
        db.add_column('deputados_mp', 'current_party', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['deputados.Party'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MP.current_party'
        db.delete_column('deputados_mp', 'current_party_id')
